...
import { Answer, Submission } from "../functions/types/submissionTypes"
...
export type PreviewAction = InitializePreviewAction | UpdateActiveIndexAction | ResetFieldAction | UpdateAnswerAction | UpdateErrorAction | UpdateLoadingAction;

export const previewReducer = (state: PreviewState, action: PreviewAction): PreviewState => {
    switch(action.type) {

        case "initialize_preview": return {
            ...state,
            submission: {
                ...state.submission,
        ...
        case "update_active_index": return {
            ...state,
            activeIndex: action.payload
        }

        case "update_answer": return {
            ...state,
            submission: {
                ...state.submission,
        ...
        case "reset_field": return {
            ...
            submission: {
                ...state.submission,
                answers: state.submission.answers.map(answer => ({...answer, value: ""}))
            }
        }

        case "update_error": return {
            ...state,
